...
<head>
    ...
    <style>
        ...
        .badge-table { background-color: #e8e6e1; color: #5a4a2a; }
        .badge-private { background-color: #2a2a2a; color: #C5A059; }
    </style>
</head>
<body class="flex min-h-screen">
    ...
    <aside class="sidebar flex flex-col shrink-0">
        ...
        <nav class="flex-1 px-4 space-y-2">
            ...
            <a href="/reservation" class="sidebar-item active flex items-center px-4 py-4 rounded-sm"><i class="fas fa-calendar-alt w-6 text-xs"></i> <span>Reservations</span></a>
                                        ...
                                        <div class="border-2 {{ $space->is_available ? 'border-gray-100 hover:border-gold' : 'border-red-200 bg-gray-50' }} overflow-hidden transition-all duration-500 peer-checked:border-gold peer-checked:shadow-lg">
                                            ...
                                            <div class="p-4">
                                                <div class="flex justify-between items-start">
                                                    ...
                                                    <span class="text-[8px] px-2 py-0.5 rounded {{ $space->type == 'private' ? 'badge-private' : 'badge-table' }}">
                                                        {{ $space->type }}
                                                    </span>
                                                </div>
